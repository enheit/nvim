-- In order to add a new color you can use ":Inspect" command in neovim while having cursor on the element @ Roman
...
-- Go Lang
vim.api.nvim_set_hl(0, "@constant.builtin.go", { fg = "#ca8f2f" })
vim.api.nvim_set_hl(0, "@type.builtin.go", { fg = "#22c55e" })
